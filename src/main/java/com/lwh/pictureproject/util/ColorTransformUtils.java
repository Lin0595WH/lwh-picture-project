 ...
 * @Author Lin
 * @Date 2025/9/3 22:29
 * @Descriptions 颜色转换工具类（数据万象给的颜色，当最后是0时，会省略一位）
 */
public class ColorTransformUtils {
     ...
     * 参考：https://blog.csdn.net/weixin_74879735/article/details/147034701?spm=1001.2014.3001.5502
     */
    ...
    public static void main(String[] args) {
        System.out.println(getStandardColor("0x000"));
    }
}
